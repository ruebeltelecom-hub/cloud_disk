...
final class NCBrandOptions: @unchecked Sendable {
    ...
    var brand: String = "Облачный Диск"
    var brandUserAgent: String = "Beltelecom"
    var textCopyrightNextcloudiOS: String = "Облачный Диск для iOS %@ · © 2026 РУП «Белтелеком»\nНа основе Nextcloud · GPL-3.0"
    var textCopyrightNextcloudServer: String = "Сервер %@"
    var loginBaseUrl: String = "https://disk.datacenter.by"
    ...
    var webLoginAutenticationProtocol: String = "bydisk://"                                     // example "abc://"
    var privacy: String = "https://www.beltelecom.by/policy-protection-of-personal-data"
    var sourceCode: String = "https://github.com/ruebeltelecom-hub/cloud_disk"
    ...
    // Capabilities Group
    var capabilitiesGroup: String = "group.by.beltelecom.disk"
    var capabilitiesGroupApps: String = "group.by.beltelecom.apps"
    ...
    var enforce_servers: [(name: String, url: String)] = [(name: "Облачный Диск", url: "https://disk.datacenter.by")]
...
final class NCBrandColor: @unchecked Sendable {
    ...
    let customer: UIColor = UIColor(red: 102.0 / 255.0, green: 52.0 / 255.0, blue: 121.0 / 255.0, alpha: 1.0) // #663479 — официальный фирменный цвет Белтелеком (брендбук, Pantone 7664 C). ВНИМАНИЕ: при use_themingColor=true это только pre-login/fallback; после входа цвет берётся с сервера (theming.color на disk.datacenter.by сейчас #2d73be синий — нужно поменять серверно на #663479)
